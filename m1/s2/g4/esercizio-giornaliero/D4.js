...
for (let chars of starWarsCharacters) {
  if (chars.gender == 'female') {
    femaleCharacters.push(chars.name, chars.hair_color, chars.eye_color);
  }
}
...
for (let chars of starWarsCharacters) {
  switch (chars.eye_color) {
    case 'blue':
      eye_color.blue.push(chars)
      break;
    case 'brown':
      eye_color.brown.push(chars)
      break;
    case 'yellow':
      eye_color.yellow.push(chars)
      break;
    case 'blue_grey':
      eye_color.blue_grey.push(chars)
      break;
    case 'red':
      eye_color.red.push(chars)
      break;
    default: eye_color
      break;
  }
